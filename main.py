 ...
 class Sniper:
    ...
    def check_version(self):
        ...
        if not response.text.rstrip() == self.version:
                print("NUEVA ACTUALIZACION ENTRA A EL SERVIDOR DE DISCORD https://discord.gg/KtrhuqDzry O VE A https://github.com/isai-Narcicista/isaisniper/blob/main/main.py COPIA EL CODIGO Y REMPLAZALO POR ESTE.")
                print("EN 60 SEGUNDOS CONTINUARA.")
                import time
                time.sleep(60)
        ...
        try:
                    ...
                    try:
                      ...
                      if datetime.datetime.now() >= start_time:
                         ...
                         pass
                    self.task = "COMPRAR ITEMS Y BUSCAR"
